...
userRouter.post("/submit-editedaddress",userMiddleware.verifyUser,usercontroller.postEditedAddress)
userRouter.get("/placeorder",userMiddleware.verifyUser,usercontroller.getPlaceOrder)
userRouter.post("/orders",userMiddleware.verifyUser,usercontroller.postOrders)
